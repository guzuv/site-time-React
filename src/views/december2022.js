...
import './december2022.css'

const December2022 = (props) => {
  return (
    <div className="december2022-container">
      <Helmet>
        <title>december2022 - guzuv says hi!</title>
        <meta
          name="description"
          content="hey, we got games and fun here at guzuv.ml!"
        />
        <meta property="og:title" content="december2022 - guzuv says hi!" />
        <meta
          property="og:description"
          content="hey, we got games and fun here at guzuv.ml!"
        />
      </Helmet>
      <div className="december2022-blog-post-card">
        <div id="blog" className="december2022-container1">
          <div className="december2022-container2">
            <span className="december2022-text"> </span>
          </div>
          <div className="december2022-container3">
            <div className="december2022-container4">
              <h1 className="december2022-text1">merry christmas!</h1>
            </div>
            <img
              alt="image"
              ...
              className="december2022-image"
            />
          </div>
          <span className="december2022-text2">December 20, 2022</span>
          <span className="december2022-text3">
          ...
          <div className="december2022-container5">
            <div className="december2022-profile">
              <img
                alt="profile"
                src="/playground_assets/catpic.png"
                className="december2022-image1"
              />
            </div>
            <span className="december2022-text4">me lol</span>
          </div>
        </div>
      </div>
    </div>
