  ...
  return (
    <div className="bounty-container">
      ...
      <div className="bounty-card-content1">
        <h3 className="bounty-text15 BigCard-Heading">mc bounty!</h3>
        <span className="bounty-text16">
          <span className="bounty-text17">
          ...
          <span className="bounty-text20">30 Robux</span>
          <br></br>
          <span>expires in: 2/21/2023 (only half of prize now).</span>
          <br></br>
          <span>SEND PROOF WITH &quot;want a game?&quot; button!</span>
          <br></br>
          <a
          ...
          <br></br>
          <span className="bounty-text27">
            SEND THE WHOLE SCREEN, INCLUDING GUZUV.GITHUB.IO!
          </span>
          <br></br>
        </span>
      </div>
      <div className="bounty-card-content2">
        <h3 className="bounty-text29 BigCard-Heading">Bounty!</h3>
        <span className="bounty-text30">
          <span className="bounty-text31">
