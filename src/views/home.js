      ...
      <div className="home-hero">
        <div className="home-hero-text-container">
          ...
          <span className="home-text">
            ...
            <br></br>
            <span>-</span>
            <span className="home-text11">BOUNTY</span>
            <span>
              <span
            ...
            <span className="home-text13">CLAIMED!</span>
            <br></br>
        ...
        <div id="blog" className="home-container02">
          ...
          <div className="home-container04">
            <div className="home-container05">
              <h1 className="home-text33">new year! </h1>
            </div>
            <img
              alt="image"
          ...
          <span className="home-text34">January 7, 2022</span>
        ...
        <div className="home-card-content">
          ...
          <Link to="/bounty" className="home-navlink2">
            <div className="home-container10">
              <span className="home-text43">who claimed it?</span>
            </div>
          </Link>
        </div>
      </div>
