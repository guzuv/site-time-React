    ...
    <div className="home-container">
      ...
      <div className="home-card-content4">
        ...
        <span className="home-text24 card-Text">
          ...
          select nearby to enable voice chat.
        </span>
        <a
        ...
        >
          <span>
            <span className="home-text26">get mining!</span>
            <br></br>
          </span>
        </a>
      </div>
      ...
      <div className="home-container2">
        <div className="home-testimonials">
          <h2 className="home-text28">peeps i feature.</h2>
      ...
      <div id="contact" className="home-contact">
        <div className="home-content-container">
          <h2 className="home-text34 section-Heading">Contact me!</h2>
          <div className="home-locations-container">
            <div className="home-location-1">
              ...
              <div className="home-email">
                ...
                <span className="home-text36">    Guzuvy</span>
              </div>
      ...
      <div data-thq="thq-dropdown" className="home-thq-dropdown list-item">
        <ul data-thq="thq-dropdown-list" className="home-dropdown-list">
          <li data-thq="thq-dropdown" className="home-dropdown list-item">
            ...
            >
              <span className="home-text42">Sub-menu Item</span>
            </div>
          </li>
          <li data-thq="thq-dropdown" className="home-dropdown1 list-item">
            ...
            >
              <span className="home-text43">Sub-menu Item</span>
            </div>
          </li>
