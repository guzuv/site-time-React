...
const Nov2022 = (props) => {
  return (
    <div className="nov2022-container">
      <Helmet>
        <title>nov2022 - guzuv says hi!</title>
        <meta
          name="description"
          content="hey, we got games and fun here at guzuv.ml!"
        />
        <meta property="og:title" content="nov2022 - guzuv says hi!" />
        <meta
          property="og:description"
          content="hey, we got games and fun here at guzuv.ml!"
        />
      </Helmet>
      <div className="nov2022-blog-post-card">
        <div className="nov2022-container1">
          <img
            alt="cross"
        ...
        <span className="nov2022-text">
          shout out to Alex Halmer for inspiring me.
        </span>
        <div className="nov2022-container2">
          <div className="nov2022-container3">
            <span className="nov2022-text1"> </span>
          </div>
          <div className="nov2022-container4">
            <h1 className="nov2022-text2">remember them all.</h1>
            <span className="nov2022-text3">  november 11, 2022</span>
          </div>
          <span className="nov2022-text4">
            <span>
          ...
          <div className="nov2022-container5">
            <div className="nov2022-profile">
              <img
                alt="profile"
                src="/playground_assets/catpic.png"
                className="nov2022-image"
              />
            </div>
            <span className="nov2022-text8">me lol</span>
          </div>
        </div>
      </div>
    </div>
