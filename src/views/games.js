      ...
      <div id="services" className="games-services">
        ...
        <div className="games-service-card1">
          <div className="games-card-content05">
            <h3 className="games-text13 bigCard-Heading">Doodle Jump.</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="games-link05 anchor button"
            >
              Get Jumping!
            </a>
          </div>
          <div className="games-card-content06">
            <h3 className="games-text15 bigCard-Heading">Doom!</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="games-link06 button anchor"
            >
              Rip and Tear!
            </a>
          </div>
          <div className="games-card-content07">
            <h3 className="games-text17 bigCard-Heading">minecraft.</h3>
          ...
          <div className="games-card-content08">
            <h3 className="games-text21 bigCard-Heading">
              friday night funkin&apos;
            </h3>
          ...
          <div className="games-card-content09">
            <h3 className="games-text25 bigCard-Heading">1v1.lol</h3>
