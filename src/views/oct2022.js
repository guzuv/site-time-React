...
const Oct2022 = (props) => {
  return (
    <div className="oct2022-container">
      <Helmet>
        <title>oct2022 - guzuv says hi!</title>
        <meta
          name="description"
          content="hey, we got games and fun here at guzuv.ml!"
        />
        <meta property="og:title" content="oct2022 - guzuv says hi!" />
        <meta
          property="og:description"
          content="hey, we got games and fun here at guzuv.ml!"
        />
      </Helmet>
      <div className="oct2022-blog-post-card">
        <div className="oct2022-container1">
          <div className="oct2022-container2">
            <span className="oct2022-text"> </span>
          </div>
          <img
            alt="image"
            ...
            className="oct2022-image"
          />
          <h1 className="oct2022-text01">new game!</h1>
          <span className="oct2022-text02">october 14, 2022</span>
          <span className="oct2022-text03">
            <span>
          ...
          <div className="oct2022-container3">
            <div className="oct2022-profile">
              <img
                alt="profile"
                src="/playground_assets/catpic.png"
                className="oct2022-image1"
              />
            </div>
            <span className="oct2022-text11">me lol</span>
          </div>
          <div className="oct2022-container4">
            <div className="oct2022-container5">
              <span className="oct2022-text12"> </span>
            </div>
            <img
              alt="image"
              ...
              className="oct2022-image2"
            />
            <h1 className="oct2022-text13">Fresh new game!</h1>
            <span className="oct2022-text14">october 25, 2022</span>
            <span className="oct2022-text15">
              <span>
            ...
            <div className="oct2022-container6">
              <div className="oct2022-profile1">
                <img
                  alt="profile"
                  src="/playground_assets/catpic.png"
                  className="oct2022-image3"
                />
              </div>
              <span className="oct2022-text20">me lol</span>
            </div>
          </div>
        </div>
      </div>
